...
def main():
    ...
    input_df = pd.read_csv("/Users/syl/Desktop/FYP/IRL DATASETS/amazon_filtered.csv")
    arr = input_df["product_name"].tolist()
    ...
    df.describe().to_csv(f"lexi_{iterations}.csv", index=True, header=True)
