...
def main():
    ...
    # Read the CSV file
    input_df = pd.read_csv("/Users/syl/Desktop/FYP/IRL DATASETS/amazon_filter_counting.csv")
    arr = input_df["actual_price"].tolist()
    ...
    df.describe().to_csv(f"counting_number_{iterations}.csv", index=True, header=True)
